                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 border-b-4 border-[#0AA6C6]">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-8">
                        {[
                            ...
                            <div key={index} className="bg-linear-to-br from-cyan-50 to-cyan-100 p-8 rounded-xl hover:shadow-lg transition-shadow">
                    ...
                    <div className="bg-linear-to-br from-[#0AA6C6] to-cyan-600 text-white p-8 rounded-xl">
