...
const FacultyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50  font-sans">
      ...
      {/* Filter Section */}
      <div className=" shadow-sm border-b border-slate-200 py-6 px-6">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {filteredDoctors.map((doc) => (
            <div
              key={doc.id}
              className="group bg-white rounded-4xl shadow-sm border border-slate-100 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-2"
            >
              {/* Image Container */}
              <div className="relative aspect-4/5 overflow-hidden bg-slate-200">
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-slate-900 via-transparent to-transparent opacity-0 group-hover:opacity-60 transition-opacity duration-500"></div>
