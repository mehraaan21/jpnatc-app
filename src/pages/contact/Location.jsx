            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 border-b-4 border-[#0AA6C6]">
                    <div className="grid md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <div className="bg-linear-to-br from-cyan-50 to-cyan-100 p-8 rounded-xl">
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 bg-[#0AA6C6] rounded-xl flex items-center justify-center text-white text-xl shrink-0">
                                        📍
                                    </div>
                                    <div>
                        ...
                        <div className="bg-linear-to-br from-cyan-100 to-cyan-200 rounded-2xl h-96 flex items-center justify-center">
