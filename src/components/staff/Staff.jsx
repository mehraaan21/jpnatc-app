...
const DepartmentsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans my-16 selection:bg-blue-100">
      {/* 1. Header Section */}
      <header className="bg-gradient-to-r from-[#0f172a] to-[#1e293b] text-white py-16 px-6 shadow-2xl relative overflow-hidden">
      ...
      <footer className="bg-slate-900 text-white py-16 px-6 mt-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 border-b border-slate-800 pb-12 mb-12">
          <div>
            <h4 className="text-xl font-bold mb-4">JPNATC, AIIMS</h4>
            <p className="text-slate-400 text-sm leading-relaxed">
              India's premier level-1 trauma center dedicated to high-quality emergency healthcare.
            </p>
          </div>
          <div>
            <h4 className="text-xl font-bold mb-4">Quick Links</h4>
            <ul className="text-slate-400 text-sm space-y-2">
              <li className="hover:text-blue-400 cursor-pointer transition-colors">Emergency Services</li>
              <li className="hover:text-blue-400 cursor-pointer transition-colors">Patient Dashboard</li>
              <li className="hover:text-blue-400 cursor-pointer transition-colors">IT Innovations</li>
            </ul>
          </div>
          <div>
            <h4 className="text-xl font-bold mb-4">Contact Info</h4>
            <p className="text-slate-400 text-sm">
              AIIMS Ring Road, New Delhi 110029 <br />
              Ph: 011-26108000, 26109000
            </p>
          </div>
        </div>
        <p className="text-center text-slate-500 text-[10px] font-black uppercase tracking-[0.3em]">
          © 2026 Jai Prakash Narayan Apex Trauma Centre. All Rights Reserved.
        </p>
      </footer>
    </div>
  );
