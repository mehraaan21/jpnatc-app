  ...
  return (
    <section className="bg-[#eef7fa] py-20">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-14">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-6 max-w-2xl mx-auto">
            Get in touch with JPNATC for any medical inquiries, appointments, 
            or general assistance. Our team is available 24/7 to help you.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
        <div className="bg-white rounded-2xl shadow-xl p-10 grid grid-cols-1 lg:grid-cols-2 gap-10 border-b-4 border-[#0AA6C6]">
          {/* Left Content */}
          <div>
